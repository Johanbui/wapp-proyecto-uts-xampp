<template>
  <div>
    <div class="app-container">
      <el-form
        ref="documentosCreateForm"
        :model="documentosCreateForm"
      ...
      >
        <div class="title-container">
          <h3 class="title">Documentos Create</h3>
        </div>
        ...
        <el-row :gutter="30">
          <el-col :span="24">
            <el-form-item prop="codigo" label="Codigo">
              <el-input
                ref="codigo"
                v-model="documentosCreateForm.codigo"
                placeholder="Codigo"
                name="codigo"
                type="text"
                tabindex="1"
        ...
        <el-row :gutter="30">
          <el-col :span="24">
            <el-form-item prop="fecha" label="Fecha">
              <el-date-picker
                v-model="documentosCreateForm.fecha"
                type="date"
                placeholder="Fecha"
              />
            </el-form-item>
...
<script>
import { create } from '@/api/documentos'
...
export default {
  ...
  methods: {
    onSubmit() {
      const params = { ...this.documentosCreateForm }
    ...
    handleSuccess(res, file) {
      ...
      this.documentosCreateForm.file_id = res.file.id
    }
  }
}
</script>
